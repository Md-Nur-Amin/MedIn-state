                ...
                <div className=" my-10  mx-auto flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-50 text-gray-800">
                    <div className="flex flex-col items-center w-full">
                        ...
                        <div className="flex flex-col w-full">
                            <textarea rows="3" placeholder="Message..." className=" border p-4 rounded-md resize-none text-gray-800 bg-gray-50"></textarea>
                    ...
                    <div className="flex items-center justify-center">
                        <a rel="noopener noreferrer" href="#" className="text-sm text-gray-600 btn"> <Link to='/' >Maybe later</Link> </a>
                    </div>
                </div>
            </div>
